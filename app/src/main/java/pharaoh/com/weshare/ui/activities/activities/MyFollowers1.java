...
import pharaoh.com.weshare.ui.activities.activities.adapters.FollowersAdapter;

public class MyFollowers1 extends RootActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_followers1);
        ...
        adapter = new FollowersAdapter(getData(), getApplicationContext());
